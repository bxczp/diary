...
// 			注意location的格式 =后面要用"" 引起来 
			window.location.href="diaryType?action=delete&diaryTypeId="+diaryTypeId;
		}
	}
...
<div class="data_list">
		...
		<span class="diaryType_add">
			<button class="btn  btn-success" type="button" onclick="javascript:window.location='diaryType?action=preSave'">增加类别</button> 
		</span>
		</div>
		<div>
<!-- 		bootstrap样式 -->
