...
<script type="text/javascript">
	function diaryDelete(diaryId) {
		if(confirm("确认删除...")){
// 			注意location的格式 =后面要用""(单引号也可以) 引起来 
			window.location.href="diary?action=delete&diaryId="+diaryId;
		}
	}
...
<body>
	<div class="data_list">
		...
		<div class="diary_action">
			...
			<button class="btn btn-danger" type="button" onclick="javascript:diaryDelete(${diary.diaryId})">删除日志</button>
		</div>
